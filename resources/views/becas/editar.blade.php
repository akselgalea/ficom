...
<div class="container card form-container">
    <form method="post" action="{{ route('beca.update', $beca['id']) }}" id="formBeca" class="mt-3 row">
        @csrf
        <h2 class="form-title">Becas</h2>
        
        <div class="form-group mb-3 col-6">
            <label class="form-label" for="nombre">Nombre</label>
            <input class="form-control @error('nombre') is-invalid @enderror" type="text" id="nombre" name="nombre" value="{{old('nombre') ?? $beca['nombre']}}">
        ...
        <div class="form-group mb-3 col-6">
            ...
            <input class="form-control @error('descuento') is-invalid @enderror" type="number" id="descuento" name="descuento" value="{{old('descuento') ?? $beca['descuento']}}" min="0" max="100">
        ...
        <div class="form-group mb-3 col-12">
            ...
            <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion">{{old('descripcion') ?? $beca['descripcion']}}</textarea>
